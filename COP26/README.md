...
| Columns                         | Description                                                           |
|:---------------------------------|:----------------------------------------------------------------------|
| `state_iso`                    | ISO 3166-1 alpha-2 two-letter country code, includes sovereign states that are members of the United Nations                              |
| `state_name`                      | Name                                       |
...
## License
Please refer to our [data hub](../) for information on licensing.
